                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          TwinkleLabel(data: 'What is your gender?', size: 24, width: MediaQuery.of(context).size.width * 0.9,),
                          TwinkleRadioList(values: data.gender.values, value: data.gender.index, width: 250, size: 22,
                      ...
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          TwinkleLabel(data: 'How old are you?', size: 24, width: MediaQuery.of(context).size.width * 0.9,),
                          TwinkleCounter(size: 20, width: 200, min: data.age.min, max: data.age.max, value: data.age.value,
                      ...
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          TwinkleLabel(data: 'During how many days do you want to quit smoking?', size: 24, width: MediaQuery.of(context).size.width * 0.9,),
                          TwinkleCounter(size: 20, width: 200, min: data.daysToSmokeBreak.min, max: data.daysToSmokeBreak.max, value: data.daysToSmokeBreak.value,
            ...
            persistentFooterButtons: [
              Row(
                children: [
                  ...
                  const TwinkleLabel(data: 'Step 1 of 2', size: 24, width: 170,),
                  //Padding(padding: EdgeInsets.symmetric(horizontal: 20),),
                  const SizedBox(width: 70,),
                  TwinkleButton(text: 'Next', selected: true, size: 24, width: 100,
                    onPressed: (){
