...
class NotificationService {
  ...
  Future<void> scheduledNotifications(
      {required int id, required String title, required String body, required DateTime dateTime, required String payload}) async {
  ...
  Future<void> delayedNotifications(
      {required int id, required String title, required String body, required Duration delayTime, required String payload}) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
        id,
        title,
        body,
